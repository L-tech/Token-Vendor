...
function App(props) {
  ...
  */
  ...
  const soldTokensEvents = useEventListener(readContracts, "Vendor", "SoldTokens", localProvider, 1);
  console.log("📟 soldTokensEvents:", soldTokensEvents);
      ...
      <BrowserRouter>
        ...
        <Switch>
          <Route exact path="/">
            ...
            <div style={{ width: 500, margin: "auto", marginTop: 64 }}>
              <div>Token Sold Events:</div>
              <List
                dataSource={soldTokensEvents}
                renderItem={item => {
                  return (
                    <List.Item key={item.blockNumber + item.blockHash}>
